...
\usepackage{amsmath}
%\usepackage{amsthm}% newtxtext ÇÊÇËÇ‡ëOÇ…ì«Ç›çûÇﬁ
...
\subsection{Fonts}
The preferred font is ÅgTimes-RomanÅh, the size to be used is 10pt.

The font size of the ÅeabstractÅf is 9pt. The length of the abstract should not exceed 250 words. Referencing or citations in the abstract is advised to be avoided.
...
Please write no more than six key words. They should be written left aligned, in 9pt, Times-Roman font, and the line must begin with the words ÅgKeywords:Åh. Each of the keywords needs to be comma separated. One line space should separate the key words from the summary.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Headings}
...
number as Åg2. Numerical ExamplesÅh. There should be 
...
Åg2.1 The Second Level HeadingsÅh. There should be 
...
Åg3.1.1 The Third Level HeadingsÅh. There should be 0.5 
...
\bibitem{3}  ÅgDescription of References SIST 02-2007Åh. Japan Science and Technology Agency. \url{https://warp.ndl.go.jp/info:ndljp/pid/12003258/jipsti.jst.go.jp/sist/handbook/sist02_2007/main.htm}, (accessed 2022-05-17). (Japanese).
\end{thebibliography}
